...
<a href="<?php echo e(route('job.create')); ?>" data-ajax-popup="true" data-size="md" data-title="<?php echo e(__('Create New Job')); ?>" data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary" data-bs-original-title="<?php echo e(__('Create')); ?>">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="badge bg-success p-2 px-3 rounded status-badge"><?php echo e(App\Models\Job::$status[$job->status]); ?></span>
                                <?php else: ?>
                                <span class="badge bg-danger p-2 px-3 rounded status-badge"><?php echo e(App\Models\Job::$status[$job->status]); ?></span>
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="Action">
                                ...
                                <span>
                                    <div class="action-btn bg-secondary ms-2">
                                        <a href="#" class="mx-3 btn btn-sm  align-items-center" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__('Job Copy')); ?>">
                                    ...
                                    <div class="action-btn bg-warning ms-2">
                                        <a href="<?php echo e(route('job.show', $job->id)); ?>" class="mx-3 btn btn-sm  align-items-center" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__('Job Detail')); ?>">
                                    ...
                                    <div class="action-btn bg-info ms-2">
                                        <a href="<?php echo e(route('job.edit', $job->id)); ?>" class="mx-3 btn btn-sm  align-items-center" data-url="" data-ajax-popup="true" data-title="<?php echo e(__('Edit Job')); ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo e(__('Edit')); ?>">
                                    ...
                                    <div class="action-btn bg-danger ms-2">
                                        ...
                                        <a href="#!" class="mx-3 btn btn-sm  align-items-center bs-pass-para" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?php echo e(__('Delete')); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\hrmgo\resources\views/job/index.blade.php ENDPATH**/ ?>