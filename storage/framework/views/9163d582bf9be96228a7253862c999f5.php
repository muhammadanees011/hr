                    ...
                    <div class="card-body employee-detail-create-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6" id="probation_days_input" style="display: none;">
                                ...
                                <?php echo Form::number('probation_days', null, ['class' => 'form-control']); ?>
...
unset($__errorArgs, $__bag); ?> border-0"
                                    ...
                                    <div class="choose-files ">
                                        <label for="document[<?php echo e($document->id); ?>]">
                                            ...
                                            <input type="file" class="form-control file <?php $__errorArgs = ['document'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?> " <?php if($document->is_required == 1): ?> required <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRMGO\resources\views/employee/create.blade.php ENDPATH**/ ?>