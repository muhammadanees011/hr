        ...
        <div class="col-xl-12">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    ...
                    <div class="card">
                        <div class="card-body employee-detail-body fulls-card">
                            <h5><?php echo e(__('Employment History')); ?></h5>
                            <hr>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="info text-sm">
                                        <strong class="font-bold"><?php echo e(__('Company Name')); ?> : </strong>
                                        <span>HeroShield Firefighters</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info text-sm font-style">
                                        <strong class="font-bold"><?php echo e(__('Designation/Role')); ?> :</strong>
                                        <span>Deputy Fire Chief</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info text-sm">
                                        <strong class="font-bold"><?php echo e(__('From')); ?> :</strong>
                                        <span><?php echo e(\Auth::user()->dateFormat($employee->dob)); ?></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="info text-sm">
                                        <strong class="font-bold"><?php echo e(__('To')); ?> :</strong>
                                        <span><?php echo e(\Auth::user()->dateFormat($employee->dob)); ?></span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <div class="card " style="height:auto">
                        <div class="card-body employee-detail-body fulls-card">
                            <h5><?php echo e(__('Achievements')); ?></h5>
                            <hr>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="info text-sm">
                                        <strong class="font-bold"><?php echo e(__('Award')); ?> :</strong>
                                        <span><?php echo e(!empty($employee->designation) ? $employee->designation->name : ''); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="info text-sm">
                                        <strong class="font-bold"><?php echo e(__('Year')); ?> :</strong>
                                        <span><?php echo e(\Auth::user()->dateFormat($employee->company_doj)); ?></span>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HRMGO\resources\views/employee/show.blade.php ENDPATH**/ ?>