...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group  col-lg-6 col-md-6">
            ...
            <?php echo e(Form::text('retirement_date', null, ['class' => 'form-control d_week', 'autocomplete' => 'off' ,'required' => 'required'])); ?>
...
<?php /**PATH C:\xampp\htdocs\HRMGO\resources\views/retirement/edit.blade.php ENDPATH**/ ?>