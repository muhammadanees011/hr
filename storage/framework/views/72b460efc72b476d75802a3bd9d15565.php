                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="form-icon-user">
                                    <div class="designation_div">
                                        <select class="form-control designation_id select2" name="designation_id" id="choices-multiple" placeholder="Select Designation">
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                <?php echo e(Form::label('employee_type', __('Select Employee Type'), ['class' => 'form-label'])); ?>

                                <div class="form-icon-user">
                                    <select class="form-control  employee_type" name="employee_type" id="employee_type" disabled>
                                        <option value="Permanent" <?php echo e(($employee->employee_type == 'Permanent') ? 'selected' : ''); ?>>Permanent</option>
                                        <option value="Probation" <?php echo e(($employee->employee_type == 'Probation') ? 'selected' : ''); ?>>Probation</option>
                                    </select>
                                    <input type="hidden" name="employee_type" value="<?php echo e($employee->employee_type); ?>">
                                </div>
                            </div>
                            <div class="form-group col-md-6" id="probation_days_input" style="display: none;">
                                <?php echo Form::label('probation_days', __('Enter Probation Days'), ['class' => 'form-label']); ?>

                                <?php echo Form::number('probation_days', $employee->probationDetails->duration, ['class' => 'form-control']); ?>
                                ...
                                <div class="float-right col-8">
                                    ...
                                    <div class="choose-files ">
                                        <label for="document[<?php echo e($document->id); ?>]">
                                            <div class=" bg-primary document cursor-pointer"> <i class="ti ti-upload px-1"></i><?php echo e(__('Choose file here')); ?>

                                            </div>
                                            <input type="file" class="form-control file  d-none <?php $__errorArgs = ['document'];
...
unset($__errorArgs, $__bag); ?>" <?php if($document->is_required == 1): ?> <?php endif; ?>
                                        ...
                                        <img id="<?php echo e('blah' . $key); ?>" src="<?php echo e(isset($employeedoc[$document->id]) && !empty($employeedoc[$document->id]) ? $logo . '/' . $employeedoc[$document->id] : asset(Storage::url("uploads/avatar/defualt.png"))); ?>" width="50%" />

                                    </div>

                                    <?php if(!empty($employeedoc[$document->id])): ?>
                                    <span class="text-xs"><a href="<?php echo e(!empty($employeedoc[$document->id]) ? $logo . '/' . $employeedoc[$document->id] : ''); ?>" target="_blank">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\hrmgo\resources\views/employee/edit.blade.php ENDPATH**/ ?>