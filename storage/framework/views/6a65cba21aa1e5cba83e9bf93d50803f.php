                ...
                <div class="container">
                    <div class="section-title bg-light">
                        ...
                        <p><?php echo e(__('Always looking for better ways to do things, innovate')); ?> <br>
                            <?php echo e(__('and help people achieve their goals')); ?>.
                        </p>
                    </div>
                    <div class="row g-4">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 job-card">
                            <div class="job-card-body">
                                <div class="d-flex mb-3 align-items-center justify-content-between ">
                                    ...
                                    <span>
                                        <?php echo e(!empty($job->branches) ? $job->branches->name : ''); ?>, <?php echo e($job->departments->name); ?> <i class="ti ti-map-pin ms-1"></i>
                                    </span>
                                    <?php endif; ?>
                                </div>
                                <h5 class="mb-3">
                                ...
                                <div class="d-flex mb-3 align-items-start flex-column flex-xl-row flex-md-row flex-lg-column">
                                    <span class="d-inline-block me-2"> <i class="ti ti-clock"></i>
                                        <?php echo e($job->contract_type); ?></span>
                                </div>
                                <div class="d-flex mb-3 align-items-start flex-column flex-xl-row flex-md-row flex-lg-column">
...
</html><?php /**PATH C:\wamp64\www\hrmgo\resources\views/job/career.blade.php ENDPATH**/ ?>