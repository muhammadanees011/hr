...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item" aria-current="page"><a href="{{ route('healthassessment.index') }}">{{ __('Health Assessment') }}</a></li>
    <li class="breadcrumb-item active" aria-current="page"></li>{{ __('Assessment Detail') }}
@endsection
                                        ...
                                        <div class="card-body pt-0 ">
                                            <address class="mb-0 text-sm">
                                                <div class="row mt-3 align-items-center">
                                                    ...
                                                    <div class="col-sm-8 text-sm"> {{ $healthassessment->employee->name }}</div>

                                                    <div class="col-sm-4 h6 text-sm">{{ __('Assessment Type') }}</div>
                                                    <div class="col-sm-8 text-sm"> {{ $healthassessment->assessment_type }}</div>

                                                    <div class="col-sm-4 h6 text-sm">{{ __('Assessment Date') }}</div>
                                                    <div class="col-sm-8 text-sm">
                                                        {{ Auth::user()->dateFormat($healthassessment->assessment_date) }}</div>
                                                </div>
                                            </address>
                                        </div>
                                    </div>
...
@push('script-page')
    ...
    <script>
        ...
        myDropzone.on("sending", function(file, xhr, formData) {
            ...
            formData.append("contract_id", {{ $healthassessment->id }});
