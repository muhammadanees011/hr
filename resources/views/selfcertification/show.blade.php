...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item" aria-current="page"><a href="{{ route('selfcertification.index') }}">{{ __('Self Certification') }}</a></li>
    <li class="breadcrumb-item active" aria-current="page"></li>{{ __('Self Certification Detail') }}
@endsection
                        ...
                        <div id="general">
                                        ...
                                        <div class="card-body pt-0 ">
                                            <address class="mb-0 text-sm">
                                                <div class="row mt-3 align-items-center">
                                                    ...
                                                    <div class="col-sm-8 text-sm"> {{ $selfcertification->employee->name }}</div>

                                                    <div class="col-sm-4 h6 text-sm">{{ __('Certification Date') }}</div>
                                                    <div class="col-sm-8 text-sm"> {{  Auth::user()->dateFormat($selfcertification->certification_date) }}</div>

                                                    <div class="col-sm-4 h6 text-sm">{{ __('Certification Title') }}</div>
                                                    <div class="col-sm-8 text-sm">
                                                        {{$selfcertification->certification_type}}
                                                    </div>
                                                </div>
                                            </address>
                                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-3">
                                    {{ Form::open(['route' => ['contracts.description.store', $selfcertification->id]]) }}
                                    <div class="col-md-12">
                                        <div class="form-group mt-3">
                                            <textarea class="summernote-simple" name="contract_description" id="contract_description" rows="3">{!! $selfcertification->details !!}</textarea>
                                        </div>
                                    </div>
                                    @can('Create Contract')
                                                        ...
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                <h6 class="text-sm mb-0">
                                                                    <a href="#!">{{ $selfcertification->certification_file }}</a>
                                                                </h6>

                                                                <p class="card-text small text-muted">
                                                                    {{ number_format(\File::size(storage_path('contract_attechment/' .  $selfcertification->certification_file)) / 1048576, 2) . ' ' . __('MB') }}
                                                                </p>
                                                            </div>
                                                            @php
                                                            ...
                                                            <div class="action-btn bg-warning p-0 w-auto    ">
                                                                <a href="{{ $attachments . '/' .  $selfcertification->certification_file }}"
                                                                ...
                                                                @can('Delete Attachment')
                                                                    @if (1 == 1 || \Auth::user()->type == 'company' || \Auth::user()->type == 'hr')
                                                                        <div class="action-btn bg-danger ms-2">
                                                                            ...
                                                                            <form action=""></form>
                                                                            {!! Form::open(['method' => 'GET', 'route' => ['contracts.file.delete', [ $selfcertification->id,  1]]]) !!}
                                                                            <a href="#!"
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                @if (\Auth::user()->type == 'company' || \Auth::user()->type == 'hr')
                                                    <form action=""></form>
                                                    {{ Form::open(['route' => ['contracts.note.store', $selfcertification->id]]) }}
...
@push('script-page')
    ...
    <script>
        ...
        myDropzone = new Dropzone("#my-dropzone", {
            ...
            url: "{{ route('contracts.file.upload', [$selfcertification->id]) }}",
        ...
        myDropzone.on("sending", function(file, xhr, formData) {
            ...
            formData.append("contract_id", {{ $selfcertification->id }});
