...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item" aria-current="page"><a href="{{ route('selfcertification.index') }}">{{ __('Self Certifications') }}</a></li>
                        ...
                        <div id="general">
                                        ...
                                        <div class="card-body pt-0 ">
                                            <address class="mb-0 text-sm">
                                                <div class="row mt-3 align-items-center">
                                                    ...
                                                    <div class="col-sm-4 h6 text-sm">{{ __('Certification Type') }}</div>
                                                    <div class="col-sm-8 text-sm"> {{ $selfcertification->certification_type }}</div>

                                                    <div class="col-sm-4 h6 text-sm">{{ __('Certification Date') }}</div>
                                                    <div class="col-sm-8 text-sm">
                                                        {{ Auth::user()->dateFormat($selfcertification->certification_date) }}</div>
                                                </div>
                                            </address>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-3">
                                    {{ Form::open(['route' => ['selfcertification.detail.store', $selfcertification->id]]) }}
                                    <div class="col-md-12">
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            @foreach ($selfcertification->files as $file)
                                                <div class=" py-3">
                                                        ...
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                ...
                                                                <p class="card-text small text-muted">
                                                                    {{ number_format(\File::size(storage_path('selfcertification_attachment/' . $file->files)) / 1048576, 2) . ' ' . __('MB') }}
                                                                </p>
                                                            </div>
                                                            @php
                                                                $attachments = \App\Models\Utility::get_file('selfcertification_attachment');
                                                            @endphp
                                                                ...
                                                                @can('Delete Attachment')
                                                                    @if (\Auth::user()->id == $file->user_id || \Auth::user()->type == 'company' || \Auth::user()->type == 'hr')
                                                                        <div class="action-btn bg-danger ms-2">
                                                                            ...
                                                                            <form action=""></form>
                                                                            {!! Form::open(['method' => 'GET', 'route' => ['selfcertification.file.delete', [$selfcertification->id, $file->id]]]) !!}
                                                                            <a href="#!"
...
@push('script-page')
    ...
    <script>
        ...
        myDropzone = new Dropzone("#my-dropzone", {
            ...
            url: "{{ route('selfcertification.file.upload', [$selfcertification->id]) }}",
