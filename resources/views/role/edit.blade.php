                    ...
                    <tbody>
                        ...
                        @foreach ($modules as $module)
                            <tr>
                                ...
                                <td>
                                    @if($module=="Anonymise Application (Can View)")
                                        <div class="row ">
                                            @php
                                                $anonymisePermissions = ["DOB","Gender","Address","Phone","City","State","Country","ZipCode","Applied for","Applied at","Resume","Cover Letter","Rating"];
                                            @endphp

                                            @foreach($anonymisePermissions as $permission)
                                                <div class="col-md-3 custom-control custom-checkbox">
                                                    {{ Form::checkbox('permissions[]', array_search($permission, $permissions), $role->permission, ['class' => 'form-check-input isscheck isscheck_' . str_replace(' ', '', $module), 'id' => 'permission' . array_search($permission, $permissions)]) }}
