...
@section('page-title')
{{ __('Edit Pension Opt-in') }}
@endsection

@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('home') }}">{{ __('Home') }}</a></li>
<li class="breadcrumb-item"><a href="{{ url('pension-opt-ins') }}">{{ __('Pension Opt-ins') }}</a></li>
<li class="breadcrumb-item">{{ __('Edit Pension Opt-ins') }}</li>
@endsection
...
<div class="">
    <div class="">
        {{ Form::model($PensionOptIn, ['route' => ['pension-opt-ins.update', $PensionOptIn->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
        <div class="row">
            <div class="col-md-6">
